...
| KV-6 | Two z-index literals, two depth tells, zero clipped rings, zero synthesised weights and zero routes with no level-1 heading ship on the Hub | UX-DR44, UX-DR45 (`epics.md:665-676`), A-1 and A-7 (`EXPERIENCE.md:760,766`), the hallmark floor `epics.md:3053-3061` | **Open**, tolerated deliberately | 2026-09-13 | Story 2-33 | _not retired_ |
...
| Status | **Open and tolerated**, on the component half only, with nothing measured in breach since 2026-09-23 (DW-116) | **Decision.** Recording a breach is not repairing it, and repairing half of one does not retire the entry. The stylesheet half is closed and the entry says where |
...
## KV-6: Two z-index literals, two depth tells, zero clipped rings, zero synthesised weights and zero routes with no level-1 heading ship on the Hub
...
sum spelled out. Two `z-index` literals (`2` twice; **three until 2026-09-23**, when Story 2-30
