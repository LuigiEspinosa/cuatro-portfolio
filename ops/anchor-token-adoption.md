...
1. **The `oklch()` values are downlevelled.** lightningcss emits an sRGB hex fallback and a
   ...
   holds the value decision; Pending Operator action 2 below records the rule that now guards the
   rest.)*
