...
Its sha256 is `7c05902467e2e84edd850cd54ab793fcfa51d02fca1394210c119c43687459db` (**Observed
2026-09-23**, by `Get-FileHash ... -Algorithm SHA256`). It has been regenerated four times, each
time under case 1 below, and each earlier value is kept so a reader can tell which file an older
dated observation was made against:
