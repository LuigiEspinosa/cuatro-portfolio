...
|---|---|---|---|---|
| 1 | **Replace the stale wording in `EXPERIENCE.md:946-947` and `:961-964` with a pointer to this file** | Operator | `:946-947` still reads "Unmeasured" for both lines. `:961-964` still says the weight is "Open, and worth measuring before Epic 2" and that the estimate is "inference from published sizes, not a measurement of your build". All four statements are now false, and a reader who reaches `EXPERIENCE.md` first will re-open a closed question | **2026-09-24.** Operator ruling 2026-09-24: in `EXPERIENCE.md` § Asset Budget the two "Unmeasured" cells are struck and point at § The narrative bundle and § The narrative assets here, the "Open, and worth measuring before Epic 2" paragraph is struck with a note that Story 2-2 measured both on 2026-08-29, and open item O-2 is struck and marked Closed. Each is dated |
...
| 5 | **Re-run it again once the non-3D front door lands (Story 2-13)** | Operator | The 140 KB budget is 102.8 percent breached today, and 245,605 of the 283,945 is JavaScript on a route with no 3D on it. Whether that story moves the number is the question this record exists to make answerable | **2026-09-10** (`22e8208`), found done and closed on the Operator ruling of 2026-09-24. The first reading after Story 2-13 landed (`3841be7`, 2026-09-07) is § The non-3D path's amendment of 2026-09-10 and § Every route's reading of that date, build `Tg4Y3fYLyWXDQsTh2jZrv`: the heaviest loadable non-3D route was `/cv` at 290,555 gzipped, 150,555 over the 140,000 budget. So the non-3D front door did not bring that path under it: what missed the ceiling was the narrative bundle every route carried then, not anything on the page. Later readings under § Every route carry the path since, the latest `/work` at 231,829, 91,829 over, on 2026-09-24 |
