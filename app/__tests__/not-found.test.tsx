 ...
 * `Page not Found` until then, and it is one of the three places the page says it was not found
 * that let the numeral be ornament (O-12 item 3, branch A): `tests/e2e/error-surface.pw.ts` reads
 * the document title, the heading and the message together with the numeral removed.
 */
