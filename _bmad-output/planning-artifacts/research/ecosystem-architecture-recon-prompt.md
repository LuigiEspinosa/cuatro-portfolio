...
| `poketracker-go` | **Go** backend + **Python** bot | — | 23 | |
| `StreamVault` | **Python** backend + **Vue** frontend | docker-compose, 2 Dockerfiles | 19 | |
| `MaiCoin` | **Solidity** contracts + React/Vite | — | 0 | Web3; deploy model differs fundamentally |
| `list-wheel` | **Angular** | — | 1 | |
| `connect-four-react` (`find-four`) | React + Vite | — | 0 | v2.0.0 |
| `Lumen` | *empty — idea only* | — | 0 | |
| `tcg-tracker` | *empty — idea only* | — | 0 | |
| `apple-music-workspace` | *`requirements.txt` only — idea stage* | — | 0 | Python |
